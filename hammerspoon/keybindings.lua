...
hs.hotkey.bind({'cmd'},'i', function() switcher:next() end)
hs.hotkey.bind({'cmd'},'u', function() switcher:previous() end)
...
module.appSpecific = {
  ["*"] = {
    activated = function()
-- Simple Vi Mode deactivated since we enabling it via Karabiner
--      enableSimpleViMode()
    end
  },
  ["Google Chrome"] = {
