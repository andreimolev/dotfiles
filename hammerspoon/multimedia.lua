...
local bind = function(hotkeyModal, fsm)
  ...
  hotkeyModal:bind("", "h", function() multimedia.mKey("previous")() end)
  hotkeyModal:bind("", "l", function() multimedia.mKey("next")() end)
  ...
  local pl = function() multimedia.mKey("play")() end
